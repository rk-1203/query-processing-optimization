...
public class MapExtendTable extends Mapper<LongWritable,Text,Text,IntWritable> 
{
	Configuration conf;
    String inst;
	...
	{		
        ...
        System.out.println("MAPPER ++++++++++_______*******--------"+propUsage);

		if( nullPer(uri[1].trim()) < NULL_THRESHOLD )
		{
			ok = true;
		...
		if(ok)
		{
			context.write(new Text(uri[1]),new IntWritable(1));
		}
	}
}
